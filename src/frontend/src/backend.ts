...
export class Backend implements backendInterface {
    ...
    async getAllContactMessages(): Promise<Array<{
        subject: string;
        name: string;
        email: string;
        message: string;
    ...
    async getAllDonations(): Promise<Array<{
        donorName: string;
        email: string;
        currency: string;
        timestamp: bigint;
    ...
    async getAllEnrollments(): Promise<Array<{
        studentName: string;
        plan: string;
        email: string;
        currency: string;
    ...
    async getCourseLiveStatus(): Promise<Array<[bigint, boolean]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCourseLiveStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCourseLiveStatusFor(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getCourseLiveStatusFor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordDonation(arg0: {
        ...
        if (this.processError) {
            try {
                const result = await this.actor.recordDonation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordEnrollment(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordEnrollment(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setCourseLive(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setCourseLive(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitApplication(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitContactMessage(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateAnnouncement(arg0: bigint, arg1: {
        title: string;
        body: string;
        date: bigint;
        language: string;
